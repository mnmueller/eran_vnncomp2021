...
class DeeppolyReluNode(DeeppolyNonlinearity):
    def transformer(self, nn, man, element, nlb, nub, relu_groups, refine, timeout_lp, timeout_milp,
                    use_default_heuristic, testing, K=3, s=-2, use_milp=False, approx=True, start_time=None):
        """
        ...
        if refine:
            refine_activation_with_solver_bounds(nn, self, man, element, nlb, nub, relu_groups, timeout_lp,
                                                 ...
                                                 K=K, s=s, use_milp=use_milp, approx=approx, start_time=start_time)
        else:
    ...
    def transformer(self, nn, man, element, nlb, nub, relu_groups, refine, timeout_lp, timeout_milp,
        ...
        if refine:
            refine_activation_with_solver_bounds(nn, self, man, element, nlb, nub, relu_groups, timeout_lp,
                                                 ...
                                                 use_milp=use_milp, start_time=start_time)
        else:
...
class DeeppolyLeakyReluNode(DeeppolyNonlinearity):
    def transformer(self, nn, man, element, nlb, nub, relu_groups, refine,
                    timeout_lp, timeout_milp, use_default_heuristic, testing, alpha=0.01, start_time=None):
        """
        transforms element with handle_tanh_layer
        ...
        if False:
            refine_activation_with_solver_bounds(nn, self, man, element, nlb, nub, relu_groups, timeout_lp,
                                                 timeout_milp, use_default_heuristic, 'deeppoly', start_time=start_time)
        else:
